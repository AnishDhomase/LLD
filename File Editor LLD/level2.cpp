...
// 💡It still violates 'Principle of Least Knowledge'
// A given module/class should have limited knowledge about other modules/classes. It should only talk to its immediate friends and not to strangers.
